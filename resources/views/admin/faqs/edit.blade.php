<x-layouts.admin :title="'Edit FAQ'" :active="'faqs'">

    <x-admin.page-header title="Edit FAQ" />

    <form method="POST" action="{{ route('admin.faqs.update', $faq) }}" class="bg-white rounded-xl border border-outline-variant/20 p-6 max-w-2xl">
        @csrf
        @method('PUT')
