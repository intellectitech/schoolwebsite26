        ...
        <div class="gallery-item" data-category="sports" data-caption="Inter-house athletics day · Term Two">
          <div class="gallery-item-inner">
            <svg class="gallery-placeholder" viewBox="0 0 480 380" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- running track oval -->
              <ellipse cx="240" cy="200" rx="180" ry="110" fill="none" stroke="#F2B705" stroke-width="8"
                opacity="0.4" />
              <ellipse cx="240" cy="200" rx="130" ry="72" fill="none" stroke="#F2B705" stroke-width="4"
                opacity="0.25" />
              <!-- centre circle -->
              ...
              <g fill="#FBF3E6" opacity="0.7">
                ...
                <path
                  d="M145,180 L142,210 M150,180 L158,205 M142,210 L135,230 M142,210 L152,230 M158,205 L165,225 M158,205 L148,225" />
                <circle cx="310" cy="175" r="10" />
                <path
                  d="M305,185 L302,215 M310,185 L318,210 M302,215 L295,235 M302,215 L312,235 M318,210 L325,230 M318,210 L308,230" />
              </g>
        ...
        <div class="gallery-item" data-category="events" data-caption="Martyrs' Day pilgrimage · 3 June 2026">
          <div class="gallery-item-inner">
            <svg class="gallery-placeholder" viewBox="0 0 480 500" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M0,390 C80,360 200,370 320,368 C400,366 450,374 480,368 L480,500 L0,500 Z" fill="#16233D"
                opacity="0.65" />
        ...
        <div class="gallery-item" data-category="classroom" data-caption="Mathematics drill · Primary Six">
          <div class="gallery-item-inner">
            <svg class="gallery-placeholder" viewBox="0 0 480 300" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- maths writing -->
              <text x="100" y="100" font-family="monospace" font-size="22" fill="#F2B705" opacity="0.75">3x² + 7x -
                4</text>
              <text x="100" y="132" font-family="monospace" font-size="18" fill="#FBF3E6" opacity="0.45">= (3x - 1)(x +
                4)</text>
              <line x1="100" y1="148" x2="380" y2="148" stroke="#FBF3E6" stroke-width="1" opacity="0.3"
                stroke-dasharray="4 4" />
              <text x="100" y="174" font-family="monospace" font-size="16" fill="#FBF3E6" opacity="0.4">x = ⅓ or x =
                -4</text>
        ...
        <div class="gallery-item" data-category="ceremonies" data-caption="Primary Seven send-off Mass · December 2025">
          <div class="gallery-item-inner">
            <svg class="gallery-placeholder" viewBox="0 0 480 420" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- chapel arch -->
              <path d="M140,360 L140,180 Q240,80 340,180 L340,360 Z" fill="none" stroke="#F2B705" stroke-width="3"
                opacity="0.4" />
              <!-- altar cloth -->
        ...
        <div class="gallery-item" data-category="sports" data-caption="Girls' netball practice · Term One">
          <div class="gallery-item-inner">
            <svg class="gallery-placeholder" viewBox="0 0 480 340" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- netball court lines -->
              <rect x="60" y="60" width="360" height="220" fill="none" stroke="#FBF3E6" stroke-width="2"
                opacity="0.3" />
              ...
              <path d="M300,300 C100,282 80,296 0,288 L0,340 L480,340 L480,290 C400,298 380,285 300,300 Z"
                fill="#204B37" opacity="0.4" />
            </svg>
            <div class="gallery-overlay">
          ...
          <div class="gallery-item-inner">
            <svg class="gallery-placeholder" viewBox="0 0 480 300" xmlns="http://www.w3.org/2000/svg">
              ...
              <g transform="translate(240,140)">
                ...
                <text x="0" y="6" text-anchor="middle" font-family="serif" font-size="16" fill="#F2B705"
                  font-weight="bold">59</text>
                <text x="0" y="-8" text-anchor="middle" font-family="sans-serif" font-size="7" fill="#FBF3E6"
                  opacity="0.8">YEARS</text>
              </g>
          ...
          <div class="gallery-item-inner">
            <svg class="gallery-placeholder" viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
              ...
              <g transform="translate(240,170)">
                <path d="M-30,-70 L-30,-10 L-70,60 Q-70,80 -40,80 L40,80 Q70,80 70,60 L30,-10 L30,-70 Z" fill="none"
                  stroke="#F2B705" stroke-width="3" opacity="0.6" />
                <!-- liquid inside -->
                <path d="M-60,40 L-40,15 L40,15 L60,40 Q60,70 40,70 L-40,70 Q-60,70 -60,40 Z" fill="#2F6B4F"
                  opacity="0.5" />
                <!-- bubbles -->
        ...
        <div class="gallery-item" data-category="sports" data-caption="Boys' football — House League final">
          <div class="gallery-item-inner">
            <svg class="gallery-placeholder" viewBox="0 0 480 380" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- football pitch -->
              <rect x="30" y="40" width="420" height="260" fill="none" stroke="#FBF3E6" stroke-width="2"
                opacity="0.25" />
              ...
              <!-- goal areas -->
              <rect x="30" y="120" width="80" height="100" fill="none" stroke="#FBF3E6" stroke-width="2"
                opacity="0.2" />
              <rect x="370" y="120" width="80" height="100" fill="none" stroke="#FBF3E6" stroke-width="2"
                opacity="0.2" />
              <!-- football -->
        ...
        <div class="gallery-item" data-category="events" data-caption="Open Day — parents and pupils in the compound">
          <div class="gallery-item-inner">
            <svg class="gallery-placeholder" viewBox="0 0 480 340" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- bunting / flags -->
              <polyline points="0,60 80,80 160,60 240,78 320,60 400,78 480,60" fill="none" stroke="#A6402E"
        ...
        <div class="gallery-item" data-category="facilities" data-caption="School garden — Young Farmers Club harvest">
          <div class="gallery-item-inner">
            <svg class="gallery-placeholder" viewBox="0 0 480 300" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- maize cob (simple) -->
              <g>
                <ellipse cx="80" cy="178" rx="12" ry="26" fill="#F2B705" opacity="0.75"
                  transform="rotate(-15,80,178)" />
                <ellipse cx="160" cy="168" rx="12" ry="26" fill="#F2B705" opacity="0.75"
                  transform="rotate(10,160,168)" />
                <ellipse cx="240" cy="175" rx="12" ry="26" fill="#F2B705" opacity="0.75"
                  transform="rotate(-8,240,175)" />
                <ellipse cx="320" cy="170" rx="12" ry="26" fill="#F2B705" opacity="0.75"
                  transform="rotate(12,320,170)" />
                <ellipse cx="400" cy="180" rx="12" ry="26" fill="#F2B705" opacity="0.75"
                  transform="rotate(-10,400,180)" />
              </g>
              <!-- leaves -->
          ...
          <div class="gallery-item-inner">
            <svg class="gallery-placeholder" viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
              ...
              <g transform="translate(240,180)">
                <path d="M-50,-80 Q-60,-20 -40,10 Q-20,40 0,44 Q20,40 40,10 Q60,-20 50,-80 Z" fill="#F2B705"
                  opacity="0.75" />
                <!-- handles -->
                <path d="M-50,-60 Q-80,-50 -78,-20 Q-76,10 -40,10" fill="none" stroke="#F2B705" stroke-width="6"
                  opacity="0.65" />
                <path d="M50,-60 Q80,-50 78,-20 Q76,10 40,10" fill="none" stroke="#F2B705" stroke-width="6"
                  opacity="0.65" />
                <!-- stem -->
                <rect x="-10" y="44" width="20" height="28" fill="#F2B705" opacity="0.7" />
                <rect x="-30" y="70" width="60" height="10" rx="4" fill="#F2B705" opacity="0.7" />
                <!-- star inside -->
                <polygon points="0,-50 6,-34 24,-34 10,-24 16,-8 0,-18 -16,-8 -10,-24 -24,-34 -6,-34" fill="#A6402E"
                  opacity="0.6" />
              </g>
              <!-- confetti dots -->
              <g opacity="0.4">
                <circle cx="80" cy="80" r="6" fill="#F2B705" />
                <circle cx="140" cy="120" r="4" fill="#A6402E" />
                <circle cx="320" cy="90" r="5" fill="#2F6B4F" />
                <circle cx="400" cy="130" r="6" fill="#F2B705" />
                <circle cx="60" cy="200" r="4" fill="#A6402E" />
                <circle cx="420" cy="200" r="5" fill="#2F6B4F" />
                <circle cx="100" cy="280" r="5" fill="#F2B705" />
                <circle cx="380" cy="270" r="4" fill="#A6402E" />
              </g>
          ...
          <div class="gallery-item-inner">
            <svg class="gallery-placeholder" viewBox="0 0 480 300" xmlns="http://www.w3.org/2000/svg">
              ...
              <g transform="translate(240,130)">
                ...
                <!-- dove shape (simple) -->
                <path
                  d="M0,-30 C20,-40 50,-30 60,-10 C70,10 50,30 20,28 L40,10 C20,20 -10,20 -30,10 C-50,0 -50,-20 -30,-28 C-10,-36 0,-30 0,-30 Z"
                  fill="#FBF3E6" opacity="0.7" />
                <!-- olive branch -->
