...
<head>
  ...
  <meta name="description" content="Meet the teachers and staff of Uganda Martyrs Primary School, Namugongo — the people who make the school what it is.">
...
<section class="page-hero">
  <div class="container reveal">
    ...
    <p class="lead">Uganda Martyrs Primary School is its people as much as its buildings. Meet the staff who plan the lessons, mark the books, coach the teams and hold the school together term after term.</p>
  </div>
    ...
    <div class="staff-lead-grid">
      ...
      <div class="staff-card">
        ...
        <div class="staff-card-body">
          ...
          <p class="staff-bio">Oversees the school's academic direction, pastoral care, staff development and relationship with the parish, parents and Diocese of Kampala. <em>Name to be added by school office.</em></p>
        </div>
      </div>
      ...
      <div class="staff-card">
        ...
        <div class="staff-card-body">
          ...
          <p class="staff-bio">Manages the timetable, streaming, exam preparation and academic standards from Primary One to Seven. Coordinates the PLE programme and UNEB registration.</p>
        </div>
      </div>
      ...
      <div class="staff-card">
        ...
        <div class="staff-card-body">
          ...
          <p class="staff-bio">Looks after pupil wellbeing, attendance, discipline and the day-to-day running of the compound. First point of contact for welfare concerns from parents.</p>
        </div>
      </div>
      ...
      <div class="staff-card">
        ...
        <div class="staff-card-body">
          ...
          <p class="staff-bio">Coordinates lesson planning, teacher appraisals and in-service training across all subjects and grades. Ensures fidelity to the NCDC curriculum.</p>
        </div>
      </div>
      ...
      <div class="staff-card">
        ...
        <div class="staff-card-body">
          ...
          <p class="staff-bio">First point of contact for female pupils on welfare, guidance and counselling matters. Coordinates girls' activities and liaises with parents on sensitive issues.</p>
        </div>
      </div>
      ...
      <div class="staff-card">
        ...
        <div class="staff-card-body">
          ...
          <p class="staff-bio">Leads morning prayer, co-ordinates weekday Mass, guides the chapel choir and maintains the school's close relationship with the Namugongo parish and shrines.</p>
        </div>
      </div>
      ...
      <div class="staff-card">
        <div class="staff-card-photo" aria-hidden="true">
          <svg viewBox="0 0 300 160" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
            ...
            <path d="M90,130 C90,100 116,84 150,84 C184,84 210,100 210,130" fill="<?= $t['accent'] ?>" opacity="0.25"/>
          </svg>
        </div>
        <div class="staff-card-body">
          <h3><?= $t['grade'] ?> Teacher</h3>
          <span class="staff-role-label"><?= $t['grade'] ?></span>
          <div><?php foreach($t['subjects'] as $s): ?><span class="staff-subject-tag"><?= $s ?></span><?php endforeach; ?></div>
        </div>
      </div>
      <?php endforeach; ?>
      ...
      <?php foreach ($deptHeads as $person): ?>
        <div class="staff-card">
          ...
          <div class="staff-card-body">
            ...
            <span class="staff-role-label"><?= htmlspecialchars($person['role']) ?><?= $person['department_name'] ? ' · ' . htmlspecialchars($person['department_name']) : '' ?></span>
            <?php if ($person['bio']): ?><p class="staff-bio"><?= htmlspecialchars($person['bio']) ?></p><?php endif; ?>
          </div>
        </div>
      <?php endforeach; ?>
    </div>
...
<section class="vacancies-section">
  ...
  <div class="container reveal">
    ...
    <p>We hire teachers who believe that patience, subject knowledge and genuine care for children are more important than any credential. If that is you, we would like to hear from you.</p>
    <div class="vacancies-grid">
      <div class="vacancy-card">
        <h3>Class Teacher — Primary Three</h3>
        <p>We are seeking a qualified and experienced primary teacher for Primary Three. The successful candidate will teach Literacy, Numeracy, Science and SST.</p>
        <span class="vacancy-type">Full-time · Permanent · Term One 2027 start</span>
      </div>
      <div class="vacancy-card">
        <h3>Primary Seven Mathematics & Science Specialist</h3>
        <p>An opportunity for a strong upper-primary teacher with a track record of excellent PLE results in Mathematics and Science.</p>
        <span class="vacancy-type">Full-time · Permanent · Immediate start</span>
      </div>
      <div class="vacancy-card">
        <h3>School Nurse (Part-time)</h3>
        <p>A registered nurse to staff the sick bay, Monday to Friday during school hours. Experience with children preferred.</p>
        <span class="vacancy-type">Part-time · Renewable contract</span>
      </div>
      <div class="vacancy-card">
        <h3>Volunteer & Teaching Practice Positions</h3>
        <p>We welcome student-teachers from accredited institutions for teaching practice placements, subject to availability and prior arrangement.</p>
...
<section class="cta-band">
  ...
  <div class="container reveal">
    ...
    <p>The best impression of any school is the one you get by walking through the gate on a school morning and watching the people who run it.</p>
