...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (time() < $_SESSION['login_locked_until']) {
        ...
        if ($username === '' || $password === '') {
            ...
            $error = "The database isn't reachable right now. Please check includes/db.php and try again.";
            if (!empty($db_connection_error)) {
                $error .= "<br><br><strong>Technical detail:</strong><br>" . htmlspecialchars($db_connection_error);
            }
        } else {
            try {
...
<div class="login-wrap">
  <div class="login-card">
    <img src="../assets/images/badge.jpg" alt="Mbuya Parents' School badge" class="login-badge">
