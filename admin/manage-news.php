...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .category-badge { display: inline-block; padding: 2px 10px; border-radius: 50px; font-size: 0.75rem; background: rgba(255,255,255,0.05); color: #666; border: 1px solid rgba(0,0,0,0.05); }
        ...
        <div class="table-container">
            ...
            <?php else: ?>
                <div class="no-data">
                    ...
                    <p>No news articles yet. <a href="add-news.php" style="color:#00C853;font-weight:600;">Create your first article</a></p>
                </div>
            <?php endif; ?>
        </div>
    </main>
