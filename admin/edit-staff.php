...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    $bio = clean($_POST['bio'] ?? '');
    $photo = !empty($uploadedImage) ? $uploadedImage : clean($_POST['photo_url'] ?? $staff['photo']);
        ...
        <div class="form-container">
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <?php if (!empty($staff['photo'])): ?>
                        <div class="current-image">
                            <p style="font-size:0.85rem;color:#666;margin-bottom:5px;">Current Photo:</p>
                            <img src="../<?= clean($staff['photo']) ?>" alt="Current photo">
                        </div>
                    <?php endif; ?>
                    ...
                    <input type="text" id="photo_url" name="photo_url" placeholder="Or enter image URL" style="margin-top:10px;" value="<?= clean($staff['photo']) ?>">
                </div>
                ...
                <div class="button-group">
                    <button type="submit" name="submit" class="btn-submit"><i class="fas fa-save"></i> Update Staff</button>
