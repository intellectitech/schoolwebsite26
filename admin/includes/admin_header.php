...
// Small helper for sidebar "unread" counters — safe even if $pdo is null
function admin_count($pdo, $sql) {
    if (!$pdo) { return 0; }
    try {
...
$newInquiriesCount = admin_count($pdo, "SELECT COUNT(*) FROM admissions_inquiries WHERE status = 'new'");
$unreadMessagesCount = admin_count($pdo, "SELECT COUNT(*) FROM contact_messages WHERE is_read = 0");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="admin-shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="admins.php" class="<?php echo $active_nav === 'admins' ? 'active' : ''; ?>">Manage Admins</a>
