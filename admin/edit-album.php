        ...
        <div class="form-container">
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" placeholder="Brief description of this album"><?= clean($album['description']) ?></textarea>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="sort_order" name="sort_order" value="<?= $album['sort_order'] ?>" min="0">
                    </div>
                    <div class="form-group checkbox">
                        <input type="checkbox" id="is_published" name="is_published" <?= $album['is_published'] ? 'checked' : '' ?>>
                        <label for="is_published">Published</label>
                    </div>
                </div>

                <div class="button-group">
                    <button type="submit" class="btn-submit"><i class="fas fa-save"></i> Update Album</button>
