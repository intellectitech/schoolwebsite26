      ...
      <?php if ($viewing): ?>
        <section class="admin-panel admin-message-detail">
          ...
          <dl class="admin-detail-list">
            <dt>From</dt>
            <dd><?= htmlspecialchars($viewing['name']) ?></dd>
            <dt>Email</dt>
            <dd><a href="mailto:<?= htmlspecialchars($viewing['email']) ?>"><?= htmlspecialchars($viewing['email']) ?></a>
            </dd>
            <?php if ($viewing['phone']): ?>
              <dt>Phone</dt>
              <dd><?= htmlspecialchars($viewing['phone']) ?></dd><?php endif; ?>
            <dt>Received</dt>
            <dd><?= date('l, d F Y \a\t H:i', strtotime($viewing['created_at'])) ?></dd>
            <dt>Status</dt>
            <dd><?= $viewing['is_read'] ? 'Read' : 'Unread' ?></dd>
          </dl>
          ...
          <div class="admin-actions">
            <form method="POST" action="messages.php">
              ...
              <button type="submit"
                class="btn btn-ghost"><?= $viewing['is_read'] ? 'Mark as unread' : 'Mark as read' ?></button>
            </form>
            <form method="POST" action="messages.php"
