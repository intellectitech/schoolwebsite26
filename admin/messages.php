    ...
    <?php else: ?>
      <table class="data-table">
        ...
        <tbody>
          ...
          <tr style="<?php echo $row['is_read'] ? '' : 'background:#fffaf0;'; ?>">
            ...
            <td class="row-actions">
              ...
              <form action="messages.php" method="POST">
                ...
                <button type="submit" class="btn btn-outline btn-sm"><?php echo $row['is_read'] ? 'Mark Unread' : 'Mark Read'; ?></button>
              </form>
              <form action="message_delete.php" method="POST" class="js-confirm-delete" data-confirm="Delete this message permanently?">
                <input type="hidden" name="csrf_token" value="<?php echo admin_csrf_token(); ?>">
