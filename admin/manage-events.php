...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .status-badge.past { background: rgba(200,200,200,0.15); color: #999; border: 1px solid rgba(200,200,200,0.1); }
        ...
        <div class="table-container">
            ...
            <?php else: ?>
                <div class="no-data">
                    ...
                    <p>No events yet. <a href="add-event.php" style="color:#00C853;font-weight:600;">Create your first event</a></p>
                </div>
            <?php endif; ?>
        </div>
    </main>
