...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .status-badge.upcoming { background: rgba(0,123,255,0.15); color: #4d9fff; border: 1px solid rgba(0,123,255,0.1); }
        .status-badge.past { background: rgba(255,255,255,0.05); color: rgba(255,255,255,0.3); border: 1px solid rgba(255,255,255,0.05); }
        ...
        <div class="table-container">
            ...
            <?php else: ?>
                <div class="no-data">
                    ...
                    <p>No events yet. <a href="add-event.php" style="color:#FF6B00;">Create your first event</a></p>
                </div>
            <?php endif; ?>
        </div>
    </main>
