<?php
// admin/add-album.php - WITH IMAGE UPLOAD
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error)) {
        ...
        $cover_image = !empty($uploadedImage) ? $uploadedImage : clean($_POST['cover_image_url'] ?? '');
        ...
        <div class="form-container">
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="cover_image_url" name="cover_image_url" placeholder="Or enter image URL" style="margin-top:10px;" value="<?= clean($_POST['cover_image_url'] ?? '') ?>">
                </div>
