<?php
// admin/add-news.php - WITH IMAGE UPLOAD
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // If no error from upload, process the form
    if (empty($error)) {
        ...
        $body = $_POST['body'] ?? '';
        $featured_image = !empty($uploadedImage) ? $uploadedImage : clean($_POST['featured_image_url'] ?? '');
        ...
        <div class="form-container">
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="featured_image_url" name="featured_image_url" placeholder="Or enter image URL" style="margin-top:10px;" value="<?= clean($_POST['featured_image_url'] ?? '') ?>">
                </div>
