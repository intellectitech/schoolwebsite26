...
<head>
    ...
    <style>
        ...
        .management-badge { display: inline-block; padding: 2px 10px; border-radius: 50px; font-size: 0.7rem; font-weight: 600; background: #FFD700; color: #1a4d2e; }
        ...
        <div class="table-container">
            ...
            <?php else: ?>
                <div style="text-align:center;padding:40px 0;">
                    ...
                    <p style="color:#666;">No staff members yet. <a href="add-staff.php" style="color:#1a4d2e;font-weight:600;">Add your first staff member</a></p>
                </div>
            <?php endif; ?>
        </div>
    </main>
