  ...
  <?php else: ?>
    ...
    <section class="article-section">
      <div class="container reveal">
        ...
        <?php else: ?>
          <svg class="article-hero-img" viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg"
            preserveAspectRatio="xMidYMid slice">
            <rect width="800" height="400" fill="<?= htmlspecialchars($article['cat_color'] ?? '#16233D') ?>" />
            <path d="M0,300 C160,250 340,240 500,270 C620,292 720,280 800,270 L800,400 L0,400 Z" fill="#2F6B4F"
              opacity="0.55" />
