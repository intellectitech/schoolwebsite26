...
<body>
    ...
    <div class="container reveal">
      ...
      <div class="highlights-grid">
        <div class="highlight-card">
          ...
          <p>Your child need not transfer schools. We take them from their very first day of primary school through to
            their PLE send-off.</p>
        </div>
        <div class="highlight-card">
          <span class="highlight-num">7</span>
          <h3>Core NCDC subjects</h3>
          <p>English, Mathematics, Science, Social Studies, Religious Education, Luganda, and Creative Arts — all taught
            to the national curriculum.</p>
        </div>
        <div class="highlight-card">
          <span class="highlight-num">3 Jun</span>
          <h3>Heritage on the doorstep</h3>
          <p>Minutes from the Basilica and Anglican Shrine. Our pupils study history on the very ground it happened,
            every year on Martyrs' Day.</p>
        </div>
        <div class="highlight-card">
          <span class="highlight-num">UNEB</span>
          <h3>Rigorous PLE preparation</h3>
          <p>Structured exam preparation begins in Primary Five, with mock assessments in Primary Six and intensive
            revision throughout Primary Seven.</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="apply-grid">
        ...
        <div class="steps-light">
          <div class="step-light">
            ...
            <div>
              ...
              <p>Call the school office or fill in the enquiry form at the bottom of this page. Our admissions office is
                open Monday to Friday, 8am – 4pm. You can also visit us in person at Namugongo, Kira Municipality.</p>
            </div>
          </div>
          <div class="step-light">
            ...
            <div>
              ...
              <p>We invite every prospective pupil for a guided walk of the compound and a short, friendly placement
                check. This is not a competitive entrance test — it helps us place your child in the right stream and
                identify any extra support they may need.</p>
            </div>
          </div>
          <div class="step-light">
            ...
            <div>
              ...
              <p>Bring the required documents to the school office. Our admissions team will verify them and prepare a
                place offer, usually within two working days.</p>
            </div>
          </div>
          <div class="step-light">
            ...
            <div>
              ...
              <p>Once fees are settled, collect the uniform list, term calendar and reading materials. You will also
                meet your child's class teacher before the first day of school.</p>
            </div>
          </div>
        </div>
        ...
        <div class="apply-aside">
          ...
          <div class="apply-aside-card">
            ...
            <p>We accept applications year-round subject to availability. The heaviest Primary One intake falls in the
              weeks before Term One opens each February. Transfer pupils may join at the start of any term.</p>
          </div>
          <div class="apply-aside-card">
            <h3>Office hours</h3>
  ...
  <section class="grade-reqs">
    ...
    <div class="container reveal">
      ...
      <p class="section-lead">There are no competitive entrance exams. Every child who meets the age and readiness
        criteria below is considered for a place.</p>
  ...
  <section class="fees-section">
    ...
    <div class="container reveal">
      ...
      <h2>Fees overview</h2>
      <p class="section-lead-light">The figures below are a guide. Please contact the school office for the current
        term's fee schedule. All fees are payable in Ugandan Shillings (UGX).</p>
      <div class="fees-grid">
        <div class="fee-card">
        ...
        <div class="fee-card">
          ...
          <span class="fee-period">Per term</span>
          <p>Includes tuition, meals, PLE revision materials, mock exams, UNEB registration and send-off celebrations.
          </p>
        </div>
      </div>
      <p class="fees-note"><strong>Note:</strong> These are indicative figures for planning purposes only. Actual fees
        are confirmed at time of enrolment. The school offers a payment plan option — speak to the bursar's office. Fees
        are reviewed each year at the start of Term One.</p>
    </div>
  </section>
    ...
    <div class="container reveal">
      ...
      <div class="faq-list">
        ...
        <div class="faq-item">
          ...
          <div class="faq-answer" role="region">
            <div class="faq-answer-inner">
              <p>We are a privately owned, Catholic-founded primary school operating under the Uganda Ministry of
                Education and Sports guidelines. We follow the national curriculum (NCDC) and our Primary Seven pupils
                sit the Uganda National Examinations Board (UNEB) Primary Leaving Examinations.</p>
            </div>
          </div>
        </div>
        ...
        <div class="faq-item">
          ...
          <div class="faq-answer" role="region">
            <div class="faq-answer-inner">
              <p>We generally admit children aged 5 – 7 years into Primary One. Children who have completed nursery
                school (Baby, Middle and Top class) are well prepared for the transition, though nursery completion is
                not a strict requirement for bright and ready younger children.</p>
            </div>
          </div>
        </div>
        ...
        <div class="faq-item">
          ...
          <div class="faq-answer" role="region">
            <div class="faq-answer-inner">
              <p>Transfer pupils may join at the start of any term, subject to available places. Mid-term transfers are
                considered case by case and generally only if the child would miss minimal instructional time. Primary
                Seven transfers are accepted in Term One only to allow the full year for PLE preparation.</p>
            </div>
          </div>
        </div>
        ...
        <div class="faq-item">
          ...
          <div class="faq-answer" role="region">
            <div class="faq-answer-inner">
              <p>Uganda Martyrs Primary School is a day school. All pupils go home at the end of each school day. We do,
                however, offer an after-school care programme for pupils whose parents or guardians cannot collect them
                at the regular closing time — please ask the office for details.</p>
            </div>
          </div>
        </div>
        ...
        <div class="faq-item">
          ...
          <div class="faq-answer" role="region">
            <div class="faq-answer-inner">
              <p>Term fees cover tuition, a hot midday meal, sports activities, Religious Education activities and a
                stationery pack. UNEB registration fees for Primary Seven pupils are included in that year's fee
                structure. Uniform, extra-curricular trips and optional activities are charged separately and always
        ...
        <div class="faq-item">
          ...
          <div class="faq-answer" role="region">
            <div class="faq-answer-inner">
              <p>Yes. While our school was founded on Catholic values and the daily rhythm includes morning prayer and
                Religious Education, we warmly welcome pupils from all faith backgrounds. Religious Education lessons
                cover both Catholic and broad Christian content in line with the NCDC syllabus. Pupils are respected as
                individuals, whatever their family's faith tradition.</p>
            </div>
          </div>
        </div>
        ...
        <div class="faq-item">
          ...
          <div class="faq-answer" role="region">
            <div class="faq-answer-inner">
              <p>We are located in Namugongo, Kira Municipality, Wakiso District — approximately 12 km northeast of
                Kampala city centre, a short walk from the Basilica of the Uganda Martyrs and the Anglican Uganda
                Martyrs Shrine. The school sits along the main Namugongo road and is accessible by matatu from the
                Northern Bypass.</p>
            </div>
          </div>
        </div>
        ...
        <div class="faq-item">
          ...
          <div class="faq-answer" role="region">
            <div class="faq-answer-inner">
              <p>Absolutely — we encourage it. Weekday visits during school hours give you a chance to see the compound,
                sit in briefly on a lesson, and meet the head teacher or admissions team. Saturday morning visits can be
                arranged by appointment. Use the enquiry form below or call our office to book a suitable time.</p>
            </div>
          </div>
        </div>
    ...
    <div class="container reveal">
      ...
      <div class="enquiry-grid">
        ...
        <div class="enquiry-info">
          <p>Fill in the form and our admissions office will respond within two working days. You are welcome to call or
            visit us directly if you prefer to speak with someone straight away.</p>
        ...
        <form class="enquiry-form" id="enquiryForm" action="process_admissions.php" method="POST" novalidate>
          ...
          <div class="field-row">
            <div class="field">
              ...
              <input id="parent-name" name="parent_name" type="text" required placeholder="Full name"
                value="<?= old($flash['old'], 'parent_name') ?>">
            </div>
            <div class="field">
              <label for="child-name">Child's name</label>
              <input id="child-name" name="child_name" type="text" required placeholder="Full name"
                value="<?= old($flash['old'], 'child_name') ?>">
            </div>
          </div>
          <div class="field-row">
            <div class="field">
              <label for="phone">Phone number</label>
              <input id="phone" name="phone" type="tel" required placeholder="+256 7..."
          ...
          <div class="field">
            <label for="current-school">Current / previous school <span
                style="text-transform:none;letter-spacing:normal">(if transferring)</span></label>
            <input id="current-school" name="current_school" type="text" placeholder="Name of current school"
              value="<?= old($flash['old'], 'current_school') ?>">
          </div>
          <div class="field">
            <label for="message">Additional information</label>
            <textarea id="message" name="message" rows="4"
              placeholder="Any background about your child, special needs, or questions for the admissions team"><?= old($flash['old'], 'message') ?></textarea>
          </div>
  ...
  <section class="cta-band">
    ...
    <div class="container reveal">
      ...
      <p>Walk the compound on a school morning, listen to assembly hymns, and meet the teachers who will shape your
